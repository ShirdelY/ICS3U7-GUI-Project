...
public class Credits extends JFrame implements ActionListener {
	...
	Credits() {
		...
		// citation 4
		JLabel credit4a = new JLabel("Five letter words: 660+ common 5 letter words in English • 7esl. 7ESL. (2021, June 13).");
		credit4a.setBounds(5, -150, 800, 800);
		add(credit4a);
		JLabel credit4b = new JLabel("Retrieved June 8, 2022, from https://7esl.com/5-letter-words/");
